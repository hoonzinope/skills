...
description: Write, review, or improve SwiftUI code with integrated iOS UX/HIG compliance checks. Use when building new SwiftUI features, refactoring existing views, auditing UI quality, or adopting modern SwiftUI patterns including state management, performance, modern APIs, accessibility, SF Symbols, Dynamic Type/color, touch-target sizing, and iOS 26+ Liquid Glass.
---

# SwiftUI Expert Skill

## Overview
Use this skill to build, review, or improve SwiftUI features with correct state management, modern API usage, Swift concurrency best practices, optimal view composition, and iOS 26+ Liquid Glass styling. It also performs iOS UX audits aligned to Apple HIG (touch targets, navigation patterns, typography scaling, semantic colors, SF Symbols, and accessibility). Prioritize native APIs, Apple design guidance, and performance-conscious patterns.
...
- Run iOS UX/HIG audit:
  - Verify 44x44pt minimum tap targets
  - Verify semantic colors and dark-mode-safe tokens
  - Verify Dynamic Type support for key layouts
  - Verify SF Symbols usage and clear icon labeling
  - Verify native navigation conventions (Tab, Stack, Sheet)
  - See `references/external/ios-ux-design.md` and `references/external/platform-design-ios.md`
...
- Apply iOS UX guardrails from the start:
  - 44pt targets, semantic colors, Dynamic Type-safe text styles
  - native components over custom reimplementations
  - accessibility labels/traits for interactive elements
...
### iOS UX / HIG Audit (see external references)
- [ ] All interactive controls satisfy 44x44pt minimum touch targets
- [ ] Primary actions placed in reachable iPhone thumb zones
- [ ] Safe-area behavior preserves essential text and controls
- [ ] Dynamic Type works at accessibility sizes without clipping core content
- [ ] Semantic colors/materials support light and dark mode
- [ ] SF Symbols used consistently; icons have clear meaning and labels
- [ ] Native iOS navigation patterns used (Tab/Stack/Sheet) with predictable gestures
- [ ] Accessibility labels/hints/traits present for custom controls
...
- `references/external/ios-ux-design.md` - iOS UX audit patterns from `mosif16/ios-ux-design`
- `references/external/platform-design-ios.md` - Apple HIG-derived iOS rules from `ehmo/platform-design-skills`
